...
\[
\text{Mean} = \frac{70 + 85 + 90 + 60 + 95}{5} = 80
\]
...
Mode: Most frequent, good for categorical data

Use the right measure based on data type and distribution

Understanding central tendency is the foundation of all statistics in data science. 🚀
